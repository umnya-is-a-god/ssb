...
При добавлении нескольких прокси можно переключать их, как показано в пункте 9.

Чтобы отключить **предупреждения об устаревании**, перейдите в Параметры > Ядро > Отключить предупреждения об устаревании.